...
def main():
    ...
    parser.add_argument('--script', nargs='*', default=[os.path.join(REPO_ROOT, 'run_baseline.sh')],
                        help='shell script(s) to read dataset commands from (default: run_baseline.sh)')
